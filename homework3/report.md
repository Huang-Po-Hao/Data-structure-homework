...
|----------|----------------------------------------------|-------------------------------------------------------------------------|----------------------------|-------------------|
| 測試一   | 1 2 0                                        | 1. 輸入 `1 2 0` 按 Enter<br>2. 觀察 `p1` 输出                          | 2                          |                   |
| 測試二   | 1 1 1                                        | 1. 輸入 `1 1 1` 按 Enter<br>2. 觀察 `p1` 输出                          | x                          |                   |
| 測試三   | 2 -1 2 2 1                                   | 1. 輸入 `2 -1 2 2 1` 按 Enter<br>2. 觀察 `p1` 输出                     | -x^2 + 2x                  |                   |
| 測試四   | 4 -1 3 2 2 -1 1 3 0                          | 1. 輸入 `4 -1 3 2 2 -1 1 3 0` 按 Enter<br>2. 觀察 `p1` 输出            | -x^3 + 2x^2 - x + 3        |                   |
| 測試五   | 0                                            | 1. 輸入 `0` 按 Enter<br>2. 觀察 `p1` 输出                              | 0                          |                   |
| 測試六   | 2 1 2 1 1 (for p1)<br>2 1 1 1 1 (for p2)     | 1. 輸入 `2 1 2 1 1` 按 Enter<br>2. 輸入 `2 1 1 1 1` 按 Enter<br>3. 觀察 `p1 + p2` | x^2 + 2x + x               |                   |
| 測試七   | 2 1 2 1 1 (for p1)<br>2 1 1 1 1 (for p2)     | 1. 輸入 `2 1 2 1 1` 按 Enter<br>2. 輸入 `2 1 1 1 1` 按 Enter<br>3. 觀察 `p1 - p2` | x^2 - x                        |                   |
| 測試八   | 2 1 2 2 1 (for p1)<br>2 1 1 1 1 (for p2)     | 1. 輸入 `2 1 2 2 1` 按 Enter<br>2. 輸入 `2 1 1 1 1` 按 Enter<br>3. 觀察 `p1 * p2` | 2x^3 + 4x^2             |                   |
| 測試九   | 2 1 2 2 1 (for p1)<br>(任意 p2)              | 1. 輸入 `2 1 2 2 1` 按 Enter<br>2. 輸入任意 `p2` 按 Enter<br>3. 觀察 `p1.Evaluate(2.0)` | 8   |                   |
